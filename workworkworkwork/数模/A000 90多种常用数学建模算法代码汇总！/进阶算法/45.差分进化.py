...
from mealpy.evolutionary_based.DE import OriginalDE as DE  # 导入差分进化算法 (Differential Evolution, DE)
...
# 使用差分进化算法 (Differential Evolution, DE) 进行优化
optimizer = DE(epoch=500, pop_size=100)  # 设置迭代次数为500次，种群大小为100个个体
...
def plot_history(history):
    ...
    plt.title("DE Iteration Curve")  # 设置图表标题
...
# 打印最优解和对应的目标值
print(f"DE Global Best Solution: {results['Solution']}, Global Best Fitness: {results['Fitness']}")
