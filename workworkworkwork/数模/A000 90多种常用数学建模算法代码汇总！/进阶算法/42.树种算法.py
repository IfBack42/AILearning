...
from mealpy.bio_based.TSA import OriginalTSA as TSA  # 导入树种算法（Tree-Seed Algorithm, TSA）
...
# 使用树种算法 (Tree-Seed Algorithm, TSA) 进行优化
optimizer = TSA(epoch=500, pop_size=100)  # 设置迭代次数为500次，种群大小为100个个体
...
def plot_history(history):
    ...
    plt.title("TSA Iteration Curve")  # 设置图表标题
...
# 打印最优解和对应的目标值
print(f"TSA Global Best Solution: {results['Solution']}, Global Best Fitness: {results['Fitness']}")
