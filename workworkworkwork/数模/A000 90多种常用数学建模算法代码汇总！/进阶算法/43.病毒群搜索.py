...
from mealpy.bio_based.VCS import OriginalVCS as VCS  # 导入病毒群搜索算法（Virus Colony Search, VCS）
...
# 使用病毒群搜索算法 (Virus Colony Search, VCS) 进行优化
optimizer = VCS(epoch=500, pop_size=100)  # 设置迭代次数为500次，种群大小为100个个体
...
def plot_history(history):
    ...
    plt.title("VCS Iteration Curve")  # 设置图表标题
...
# 打印最优解和对应的目标值
print(f"VCS Global Best Solution: {results['Solution']}, Global Best Fitness: {results['Fitness']}")
